...
const priorAuth: StageDetail = {
  ...
  sections: [
    ...
    {
      kind: 'policyCitation',
      title: 'E · NCCN guideline cited in appeal',
      source: 'NCCN Non-Small Cell Lung Cancer Guidelines v2.2025',
    ...
    {
      kind: 'policyCitation',
      title: 'F · Aetna policy contradiction surfaced by AI',
...
const payment: StageDetail = {
  ...
  sections: [
    ...
    {
      kind: 'arPriority',
      title: 'C · Patient balance & AI collections — Mr. Chen',
      rows: [
        {
          ...
          daysAR: 12,
          propensity: 0.82,
          recommendedAction: 'Enroll 12-month 0% APR plan ($309/mo); already accepted by patient.',
    ...
    },
    {
      ...
      body: 'Patient signed up for 12-month plan via SMS link in 22 seconds. Propensity-to-pay score 82% (high) — based on income proxy, prior payment history (full upfront $500 collected), and Aetna FEP supplement enrollment. AI Patient Stmt Bot handles autopay reconciliation; satisfaction survey rating 4.7/5.0.',
    },
  ],
};
